...
import { UpdateUserStatus_ext } from 'wasp/server/operations/actions'
...
// PUBLIC API
export const updateUserStatus: ActionFor<UpdateUserStatus_ext> = createAction<UpdateUserStatus_ext>(
  'operations/update-user-status',
  ['UserStatus'],
)
