...
import { GetUserStatus_ext } from 'wasp/server/operations/queries'
...
// PUBLIC API
export const getUserStatus: QueryFor<GetUserStatus_ext> = createQuery<GetUserStatus_ext>(
  'operations/get-user-status',
  ['UserStatus'],
)
