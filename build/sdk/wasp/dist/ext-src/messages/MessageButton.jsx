...
const MessageButton = () => {
    return (<li className='relative' x-data='{ dropdownOpen: false, notifying: true }'>
      <WaspRouterLink className='relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white' to={routes.AdminMessagesRoute.to}>
...
//# sourceMappingURL=MessageButton.jsx.map