import { updateUserStatus } from 'wasp/client/operations';
import { useState } from 'react';
export default function UserStatusPage() {
    const [location, setLocation] = useState('unknown');
    const [registrationString, setRegistrationString] = useState('unknown');
    ...
    return (<div className='mt-10 px-6'>
      ...
      <div className='inline-flex w-full justify-end'>
        <button onClick={getLocation} className='inline-flex justify-center mx-8 py-2 px-4 border border-transparent shadow-md text-sm font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'>
          Get location
        </button>
      </div>
      <div className='inline-flex w-full justify-end'>
    ...
    onClick={subscribeToPushNotifications} className='inline-flex justify-center mx-8 py-2 px-4 border border-transparent shadow-md text-sm font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'>
          Subscribe to push notifications
        </button>
      </div>
    </div>);
}
//# sourceMappingURL=UserStatusPage.jsx.map