import { type _User, type _GptResponse, type _Task, type _File, type _UserStatus, type _DailyStats, type AuthenticatedQueryDefinition, type Payload } from 'wasp/server/_types';
...
export type GetUserStatus<Input extends Payload = never, Output extends Payload = Payload> = AuthenticatedQueryDefinition<[
    _UserStatus
], Input, Output>;
