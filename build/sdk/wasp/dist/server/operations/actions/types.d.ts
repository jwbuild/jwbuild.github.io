import { type _User, type _Task, type _GptResponse, type _File, type _UserStatus, type AuthenticatedActionDefinition, type Payload } from 'wasp/server/_types';
...
export type UpdateUserStatus<Input extends Payload = never, Output extends Payload = Payload> = AuthenticatedActionDefinition<[
    _UserStatus
], Input, Output>;
