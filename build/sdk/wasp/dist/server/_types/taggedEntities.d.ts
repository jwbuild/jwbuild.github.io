import { type Entity, type EntityName, type User, type UserStatus, type GptResponse, type Task, type File, type DailyStats, type PageViewSource, type Logs, type ContactFormMessage } from 'wasp/entities';
export type _User = WithName<User, "User">;
export type _UserStatus = WithName<UserStatus, "UserStatus">;
...
export type _Entity = _User | _UserStatus | _GptResponse | _Task | _File | _DailyStats | _PageViewSource | _Logs | _ContactFormMessage | never;
