...
export const routes = {
    ...
    UserStatusRoute: {
        to: "/user-status",
        build: (options) => interpolatePath("/user-status", undefined, options === null || options === void 0 ? void 0 : options.search, options === null || options === void 0 ? void 0 : options.hash),
    },
    AdminRoute: {
        to: "/admin",
    ...
    NotFoundRoute: {
        to: "*",
        build: (options) => interpolatePath("*", options.params, options === null || options === void 0 ? void 0 : options.search, options === null || options === void 0 ? void 0 : options.hash),
    },
    AdminMessagesRoute: {
        to: "/admin/messages",
