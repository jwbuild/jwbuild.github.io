...
import { updateUserStatus as updateUserStatus_ext } from 'wasp/ext-src/user/operations'
...
// PRIVATE API
export type UpdateUserStatus_ext = typeof updateUserStatus_ext

// PUBLIC API
export const updateUserStatus: AuthenticatedOperationFor<UpdateUserStatus_ext> =
  createAuthenticatedOperation(
    updateUserStatus_ext,
    {
