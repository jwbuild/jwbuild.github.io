...
import { getUserStatus as getUserStatus_ext } from 'wasp/ext-src/user/operations'
...
// PRIVATE API
export type GetUserStatus_ext = typeof getUserStatus_ext

// PUBLIC API
export const getUserStatus: AuthenticatedOperationFor<GetUserStatus_ext> =
  createAuthenticatedOperation(
    getUserStatus_ext,
    {
